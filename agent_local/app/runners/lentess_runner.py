...
def _launch_args() -> list:
    """Chrome visible y al frente desde el inicio.
    No se minimiza, porque si PAMI muestra captcha/OTP Windows suele impedir
    traerlo correctamente al frente desde un proceso en segundo plano.
    """
    return [
        "--start-maximized",
